...
export default function LandingPage() {
  ...
  const teamMembers = [
    {
      ...
      roles: [
        { title: 'Fullstack Developer', company: 'Zemenay-Tech (Efuye Gela)', link: 'https://www.zemenaytech.com/' }
      ],
    ...
    },
    {
      ...
      experience: '3+ yrs experience',
      roles: [
        { title: 'Mobile App Developer', company: '', link: 'https://startupgarage.africa/' }
      ],
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed bottom-8 right-8 z-50 transition-all duration-500 ease-in-out ${showScrollTop ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'
          }`}
      >
        <button
          onClick={scrollToTop}
      ...
      <main className="flex-1 w-full">
        ...
        <section className="relative w-full h-[100dvh] min-h-[700px] flex flex-col items-center justify-center overflow-hidden bg-[#2b1d12] text-primary-foreground">
          ...
          />
          <div className="absolute -top-40 -left-28 h-[540px] w-[540px] rounded-full bg-amber-200/25 blur-[130px] z-0 pointer-events-none isolate animate-aura" />
          <div className="absolute top-16 right-[-120px] h-[500px] w-[500px] rounded-full bg-orange-400/20 blur-[120px] z-0 pointer-events-none isolate animate-aura-slow" />
          <div className="absolute -bottom-44 left-1/2 -translate-x-1/2 h-[520px] w-[900px] rounded-full bg-black/30 blur-[120px] z-0 pointer-events-none isolate animate-aura-slower" />
        ...
        <section className="pt-32 pb-4 w-full bg-white border-b-0">
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24 text-center">
        ...
        <section id="features" className="py-24 lg:py-32 w-full bg-white border-b border-zinc-200">
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24">
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
              ...
              <div className="max-w-xl">
                ...
                <h3 className="text-5xl lg:text-6xl xl:text-7xl font-medium tracking-tight mb-8 leading-[1.05]">
                  Personalize the guest journey instantly.
                </h3>
                <p className="text-xl opacity-70 leading-relaxed font-light">
                  Zuri is a lightweight AI widget that embeds seamlessly into your resort's website. From the moment a visitor arrives, it acts as a dedicated 24/7 concierge—providing immediate, contextual assistance to elevate Ethiopian hospitality to the next level.
                </p>
              </div>
          ...
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24">
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-start relative">
              ...
              <div className="max-w-xl lg:sticky lg:top-[30vh] lg:pb-24">
                ...
                <p className="text-xl opacity-70 leading-relaxed font-light">
                  Hospitality means welcoming everyone. Zuri breaks down language barriers by fluently speaking 8 languages, including Amharic, Tigrinya, Oromifa, and Somali. Local and international guests can tap, speak naturally, and feel instantly understood.
                </p>
              </div>
        ...
        <section id="integrations" className="py-24 lg:py-32 w-full bg-white border-b border-zinc-200">
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24">
            ...
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
              ...
              <div className="max-w-xl">
                <div className="text-sm font-semibold tracking-widest uppercase mb-6 opacity-60">03 / Agentic Concierge</div>
                <h3 className="text-5xl lg:text-6xl xl:text-7xl font-medium tracking-tight mb-8 leading-[1.05]">
                  A proactive, smart concierge.
                </h3>
                <p className="text-xl opacity-70 leading-relaxed font-light">
                  Zuri does more than answer FAQs—it anticipates guest needs. Trained entirely on your property's data, it proactively suggests personalized guest experiences, effortlessly resolving requests and securing bookings to guarantee a flawless stay.
                </p>
              </div>
              ...
              <div className="bg-primary/5 rounded-3xl h-fit flex items-center justify-center p-8 lg:p-16 border border-primary/10 w-full">
                <div className="w-full max-w-md bg-white p-8 lg:p-10 rounded-2xl shadow-2xl border border-black/5 flex flex-col gap-8">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest opacity-40">Guest Request</div>
                    <div className="text-lg sm:text-xl font-light">"Recommend a nice dinner spot with a view and book a table for two tonight."</div>
                  </div>

                  <div className="flex flex-col gap-2 pt-2">
                    <div className="text-[10px] sm:text-xs font-semibold uppercase tracking-widest opacity-40">Agent Action</div>
                    <div className="flex flex-col gap-3 bg-zinc-100 p-5 rounded-xl border border-black/5 shadow-inner text-zinc-900">
                      <p className="text-sm opacity-80 leading-normal">
                        "I highly recommend The Azure Deck. I have confirmed your window table for 7:00 PM."
                      </p>
                      <div className="flex items-center gap-2 mt-1">
                        <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
                        <span className="text-xs font-medium uppercase tracking-wide opacity-50">Reservation Complete</span>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24">
            ...
            <div className="text-center max-w-2xl mx-auto mb-20">
              ...
              <p className="text-xl opacity-70 font-light leading-relaxed">
                No engineering required. Just upload your existing PDFs, paste our single-line widget code, and instantly deploy an AI concierge that works 24/7.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              <div className="space-y-4">
                ...
                <p className="opacity-70 font-light">Register your property and securely connect your booking system.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="opacity-70 font-light">Upload your PDFs. We instantly train a custom agent on your exact property data.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="opacity-70 font-light">Paste our one-line JavaScript snippet directly into your website's header.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <p className="opacity-70 font-light">Watch your new AI concierge instantly elevate the digital guest experience and securely handle complex inquiries.</p>
              </div>
            </div>
          </FadeInView>
        </section>
        ...
        <section className="py-40 w-full bg-primary text-primary-foreground text-center">
          <FadeInView className="mx-auto w-full max-w-[1920px] px-8 lg:px-24 flex flex-col items-center">
