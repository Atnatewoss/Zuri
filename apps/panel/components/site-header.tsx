    ...
    <nav className={`absolute top-0 w-full z-50 font-sans pointer-events-none ${darkText ? 'text-zinc-900' : 'text-white'}`}>
      <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between px-8 lg:px-24 py-6">
        ...
        <div className="flex items-center pointer-events-auto">
          ...
          <Button asChild className={darkText ? "rounded-full px-8 bg-zinc-900 hover:bg-zinc-800 text-white font-semibold tracking-tight h-12 shadow-xl" : "rounded-full px-8 bg-white hover:bg-white/90 text-black font-semibold tracking-tight h-12 shadow-xl"}>
